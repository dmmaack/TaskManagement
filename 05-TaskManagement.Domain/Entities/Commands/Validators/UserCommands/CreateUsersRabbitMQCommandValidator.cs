...
namespace TaskManagement.Domain.Entities.Commands.Validators.UserCommands;

public class ProducerUsersRabbitMQCommandValidator : AbstractValidator<ProducerUsersRabbitMQCommand>
{
    public ProducerUsersRabbitMQCommandValidator()
    {
        RuleFor(x => x)
