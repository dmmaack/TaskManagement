...
public class BaseRepository<T> : IBaseRepository<T> where T : BaseEntity
{
    ...
    public async Task<IEnumerable<T>> GetAsync(Expression<Func<T, bool>> expression, bool asNoTracking = false)
        => asNoTracking
    ...
    public async Task<T> GetByIdAsync(long id, bool asNoTracking = false)
    {
